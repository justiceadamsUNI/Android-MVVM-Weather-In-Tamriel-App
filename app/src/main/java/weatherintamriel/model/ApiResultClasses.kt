...
data class CityResult(val id: Long,
                      val name: String,
...
data class ForecastResult(val dt: Long,
...
data class TemperatureResult(val day: Float,
                             val min: Float,
                             val max: Float,
                             val night: Float,
                             val eve: Float,
...
data class WeatherResult(val id: Long,
                         val main: String,
                         val description: String,
                         val icon: String)

data class CurrentWeatherResult(val weather: List<WeatherResult>,
                                val main: MainResult,
                                val dt: Long)
